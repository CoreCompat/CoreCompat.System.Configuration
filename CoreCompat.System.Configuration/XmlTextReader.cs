...
{
    internal partial class XmlTextReader : XmlReader, IXmlLineInfo
    {
        //
        // Fields
        //
        ...
        // Constructor
        //
        internal XmlTextReader(XmlReader baseReader)
        {
        ...
        internal XmlTextReader(Stream stream)
            : this(XmlReader.Create(stream))
        {
        }

        internal XmlTextReader(TextReader reader)
